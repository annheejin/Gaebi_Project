...
import com.example.heejin.gaebi_project.Activity.VideoActivity;
...
public class MainActivity extends Activity implements VoiceManager.VoiceInterface {
...
//        MakeSpeechRecognizer();
        ...
        showDefaultValues();
        setSpeakButton();
        mApplication.getmVoiceManager().startListening(MainActivity.this, str);
    }//onCreateEnd
...
//                                    AsyncTask Backgound Thread
    ...
    public void OnResult(String str) {
        mHandler.sendMessageDelayed(mHandler.obtainMessage(VoiceManager.SUCCEED_RECOGNIZE, str),400);//핸들러를 이용한 타이머 이벤트 , 타이머에 따라 과정을 반복함 1000=1초
    }
